...
void ILI9341_HW_init (void)
{
	...
	/*Initilize CSX pin*/
	GPIO_init_direct(ILI9341_CSX_PORT,ILI9341_CSX_PIN,GPIO_MODE_OUT,GPIO_OUTPUT_TYPE_PP,GPIO_OUTPUT_VERY_HIGH_SPEED,GPIO_PU,0);
	
	/*Initilize DCX pin*/
	GPIO_init_direct(ILI9341_DCX_PORT,ILI9341_DCX_PIN,GPIO_MODE_OUT,GPIO_OUTPUT_TYPE_PP,GPIO_OUTPUT_VERY_HIGH_SPEED,GPIO_PU,0);

	/*Initilize RST pin*/
	GPIO_init_direct(ILI9341_RST_PORT,ILI9341_RST_PIN,GPIO_MODE_OUT,GPIO_OUTPUT_TYPE_PP,GPIO_OUTPUT_VERY_HIGH_SPEED,GPIO_PU,0);
